    ...
    sequences: [
      ...
      },
      {
        ...
        characters: [
          ...
          { char: '筆', pinyin: 'bǐ', zhuyin: 'ㄅㄧˇ', meaning: 'pen', difficulty: 1, exampleSentence: '這是一支筆。', exampleTranslation: 'This is a pen.' },
          ...
          { char: '快', pinyin: 'kuài', zhuyin: 'ㄎㄨㄞˋ', meaning: 'fast', difficulty: 1, exampleSentence: '跑得很快。', exampleTranslation: 'Run very fast.' },
          { char: '錢', pinyin: 'qián', zhuyin: 'ㄑㄧㄢˊ', meaning: 'money', difficulty: 1, exampleSentence: '多少錢？', exampleTranslation: 'How much money?' },
          ...
          { char: '貴', pinyin: 'guì', zhuyin: 'ㄍㄨㄟˋ', meaning: 'expensive', difficulty: 2, exampleSentence: '太貴了。', exampleTranslation: 'Too expensive.' },
          ...
          { char: '紅', pinyin: 'hóng', zhuyin: 'ㄏㄨㄥˊ', meaning: 'red', difficulty: 1, exampleSentence: '紅色。', exampleTranslation: 'Red.' },
          { char: '白', pinyin: 'bái', zhuyin: 'ㄅㄞˊ', meaning: 'white', difficulty: 1, exampleSentence: '白色。', exampleTranslation: 'White.' },
          { char: '都', pinyin: 'dōu', zhuyin: 'ㄉㄡ', meaning: 'all / both', difficulty: 2, exampleSentence: '我們都是學生。', exampleTranslation: 'We are all students.' },
          { char: '好', pinyin: 'hǎo', zhuyin: 'ㄏㄠˇ', meaning: 'good', difficulty: 1, exampleSentence: '你好。', exampleTranslation: 'Hello.' },
          { char: '看', pinyin: 'kàn', zhuyin: 'ㄎㄢˋ', meaning: 'to look', difficulty: 1, exampleSentence: '看書。', exampleTranslation: 'Read a book.' },
          { char: '常', pinyin: 'cháng', zhuyin: 'ㄔㄤˊ', meaning: 'often', difficulty: 1, exampleSentence: '常常。', exampleTranslation: 'Often.' },
          { char: '穿', pinyin: 'chuān', zhuyin: 'ㄔㄨㄢ', meaning: 'to wear', difficulty: 1, exampleSentence: '穿衣服。', exampleTranslation: 'Wear clothes.' },
          ...
          { char: '件', pinyin: 'jiàn', zhuyin: 'ㄐㄧㄢˋ', meaning: 'measure word for clothes', difficulty: 2, exampleSentence: '一件衣服。', exampleTranslation: 'A piece of clothing.' },
    ...
    sequences: [
      ...
      },
      {
        ...
        characters: [
          ...
          { char: '末', pinyin: 'mò', zhuyin: 'ㄇㄛˋ', meaning: 'end / last', difficulty: 2, components: ['木', '一'], exampleSentence: '週末愉快。', exampleTranslation: 'Have a nice weekend.' },
          { char: '週', pinyin: 'zhōu', zhuyin: 'ㄓㄡ', meaning: 'week', difficulty: 2, components: ['辶', '周'], exampleSentence: '週末。', exampleTranslation: 'Weekend.' },
          { char: '昨', pinyin: 'zuó', zhuyin: 'ㄗㄨㄛˊ', meaning: 'yesterday', difficulty: 2, exampleSentence: '昨天星期幾？', exampleTranslation: 'What day was yesterday?' },
          { char: '明', pinyin: 'míng', zhuyin: 'ㄇㄧㄥˊ', meaning: 'bright / tomorrow', difficulty: 2, exampleSentence: '明天見。', exampleTranslation: 'See you tomorrow.' },
          {
            char: '天', pinyin: 'tiān', zhuyin: 'ㄊㄧㄢ', meaning: 'day / sky', difficulty: 2, components: ['一', '大'], exampleSentence: '今天天氣很好。', exampleTranslation: 'Also: Today\'s weather is good.'
          },
          // Page 2
          ...
          { char: '日', pinyin: 'rì', zhuyin: 'ㄖˋ', meaning: 'sun / day', difficulty: 1, components: ['日'], exampleSentence: '今天是星期日。', exampleTranslation: 'Today is Sunday.' },
          { char: '生', pinyin: 'shēng', zhuyin: 'ㄕㄥ', meaning: 'student / life', difficulty: 2, exampleSentence: '生日快樂。', exampleTranslation: 'Happy Birthday.' },
          ...
          { char: '上', pinyin: 'shàng', zhuyin: 'ㄕㄤˋ', meaning: 'up / on / above', difficulty: 1, components: ['上'], exampleSentence: '貓在桌子上。', exampleTranslation: 'The cat is on the table.' },
          { char: '晚', pinyin: 'wǎn', zhuyin: 'ㄨㄢˇ', meaning: 'evening / late', difficulty: 3, components: ['日', '免'], exampleSentence: '晚安。', exampleTranslation: 'Good night.' },
          { char: '樂', pinyin: 'lè', zhuyin: 'ㄌㄜˋ', meaning: 'happy / music', difficulty: 2, components: ['白', '幺', '木'], exampleSentence: '生日快樂。', exampleTranslation: 'Happy Birthday.' },
          // Page 4
          { char: '熱', pinyin: 'rè', zhuyin: 'ㄖㄜˋ', meaning: 'hot', difficulty: 3, exampleSentence: '今天很熱。', exampleTranslation: 'It is hot today.' },
          { char: '見', pinyin: 'jiàn', zhuyin: 'ㄐㄧㄢˋ', meaning: 'to see / meet', difficulty: 2, exampleSentence: '再見。', exampleTranslation: 'Goodbye.' },
          { char: '再', pinyin: 'zài', zhuyin: 'ㄗㄞˋ', meaning: 'again / goodbye', difficulty: 2, exampleSentence: '再見。', exampleTranslation: 'Goodbye.' },
        ]
      },
      {
        id: 'test-3',
